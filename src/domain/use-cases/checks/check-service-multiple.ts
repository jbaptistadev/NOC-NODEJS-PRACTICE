...
export class CheckServiceMutiple implements CheckServiceUseCase {
  constructor(
    private logRepositories: LogRepository[],
    private sucessCallback: SuccessCallback,
    private errorCallback: ErrorCallback
  ) {
    if (logRepositories === undefined || logRepositories.length === 0) {
